...
namespace helengine::gamecube {
    ...
    /// </summary>
    class GameCubeAudioBackend final : public ::IAudioBackend {
    public:
        /// <summary>
        /// Initializes the GameCube audio mixer and default bus gains.
        /// </summary>
        GameCubeAudioBackend();

        /// <summary>
        /// Stops active voices and tears down the GameCube audio mixer.
        /// </summary>
        ~GameCubeAudioBackend();
