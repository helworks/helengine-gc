...
/// <summary>
/// Stores the schema and field identifiers used by GameCube fixed-pipeline material cooking.
/// </summary>
public static class GameCubeMaterialSchemaIds {
    /// <summary>
    /// Standard textured GameCube schema id.
    /// </summary>
    public const string StandardTexturedSchemaId = "gamecube-standard-textured";
