...
class RuntimeDirectionalShadowSunSweepComponentDeserializer : public IRuntimeComponentDeserializer
{
public:
    virtual ~RuntimeDirectionalShadowSunSweepComponentDeserializer() = default;
