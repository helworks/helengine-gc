...
class RuntimeDirectionalShadowTowerSpinComponentDeserializer : public IRuntimeComponentDeserializer
{
public:
    virtual ~RuntimeDirectionalShadowTowerSpinComponentDeserializer() = default;
