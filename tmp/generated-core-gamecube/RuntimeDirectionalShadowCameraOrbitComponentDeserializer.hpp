...
class RuntimeDirectionalShadowCameraOrbitComponentDeserializer : public IRuntimeComponentDeserializer
{
public:
    virtual ~RuntimeDirectionalShadowCameraOrbitComponentDeserializer() = default;
