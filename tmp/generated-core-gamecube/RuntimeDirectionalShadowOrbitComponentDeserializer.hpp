...
class RuntimeDirectionalShadowOrbitComponentDeserializer : public IRuntimeComponentDeserializer
{
public:
    virtual ~RuntimeDirectionalShadowOrbitComponentDeserializer() = default;
