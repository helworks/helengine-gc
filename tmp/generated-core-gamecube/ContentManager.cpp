...
ContentManager::ContentManager(std::string rootDirectory) : DefaultProcessorsByTypeAndExtension(), ProcessorRegistrationsById(), RootDirectoryPath()
{
    ...
    {
throw ([&]() {
auto __ctor_arg_00000026 = "Root directory must be provided.";
auto __ctor_arg_00000027 = "rootDirectory";
...
bool ContentManager::IsProcessorRegistered(std::string processorId)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_00000028 = "Processor id must be provided.";
auto __ctor_arg_00000029 = "processorId";
...
T ContentManager::LoadProcessedContent(std::string fullPath, ::IContentProcessor_1<T>* processor)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_0000002A = "Content path must be provided.";
auto __ctor_arg_0000002B = "fullPath";
...
std::string ContentManager::NormalizeExtension(std::string extension)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_0000002C = "Extension must be provided.";
auto __ctor_arg_0000002D = "extension";
...
std::string ContentManager::ResolveContentPath(std::string assetPath)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_0000002E = "Asset path must be provided.";
auto __ctor_arg_0000002F = "assetPath";
...
throw new ArgumentNullException("requestedType");
    ...
    {
throw ([&]() {
auto __ctor_arg_00000030 = "Content path must be provided.";
auto __ctor_arg_00000031 = "fullPath";
...
bool ContentManager::TryResolveRegisteredExtension(std::string fileName, Dictionary<std::string, ::ContentProcessorRegistration*>* registrationsByExtension, std::string& matchedExtension)
{
    ...
    {
throw ([&]() {
auto __ctor_arg_00000034 = "File name must be provided.";
auto __ctor_arg_00000035 = "fileName";
