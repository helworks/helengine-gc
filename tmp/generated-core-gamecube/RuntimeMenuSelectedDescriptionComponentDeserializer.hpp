...
class RuntimeMenuSelectedDescriptionComponentDeserializer : public IRuntimeComponentDeserializer
{
public:
    virtual ~RuntimeMenuSelectedDescriptionComponentDeserializer() = default;
