...
auto __object_000000B9 = ::InputFrameState();
__object_000000B9.set_Keyboard(this->keyboardState);
__object_000000B9.set_Mouse(this->mouseState);
return __object_000000B9;
})());
}
...
this->EnsureInputStateCaptured();
{
auto __finallyGuard_000000BA = he_cpp_make_scope_exit([&]() {
...
auto __object_000000BB = ::InputPointerState();
__object_000000BB.set_Connected(true);
__object_000000BB.set_X(this->mouseState.get_X());
__object_000000BB.set_Y(this->mouseState.get_Y());
__object_000000BB.set_DeltaX(this->mouseDelta.X);
__object_000000BB.set_DeltaY(this->mouseDelta.Y);
__object_000000BB.set_ScrollDelta(this->GetMouseScrollWheelDelta());
__object_000000BB.set_Buttons(this->BuildPointerButtonMask(this->mouseState));
return __object_000000BB;
})());
...
auto __object_000000BC = ::InputActionState();
__object_000000BC.set_Value(0.0f);
__object_000000BC.set_IsDown(false);
__object_000000BC.set_WasPressed(false);
__object_000000BC.set_WasReleased(previousState.get_IsDown());
return __object_000000BC;
})();
}
