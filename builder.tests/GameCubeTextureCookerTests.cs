...
/// <summary>
/// Verifies GameCube-native texture cooking produces prepacked GX payloads from shared-engine RGBA32 textures.
/// </summary>
public sealed class GameCubeTextureCookerTests {
    /// <summary>
    ...
    public void CookTexture_WhenUsingRgba32Source_ProducesPrepackedGxRgb5A3Payload() {
        GameCubeTextureCooker cooker = new GameCubeTextureCooker();
