...
/// <summary>
/// Writes a fake GameCube image artifact so builder tests can verify orchestration without a real GCM writer.
/// </summary>
public sealed class FakeGameCubeImagePackager : IGameCubeImagePackager {
    /// <summary>
    /// Writes a fake GameCube image artifact to the requested output path.
    /// </summary>
