...
HELENGINE_GAMECUBE_MEMORY_CARD_DIAGNOSTIC_JOURNAL ?= 0
HELENGINE_GAMECUBE_NINTENDONT_HANDOFF_DIAGNOSTIC ?= 0
HELENGINE_GAMECUBE_FIRST_FRAME_TRACE_DIAGNOSTIC ?= 0
HELENGINE_GAMECUBE_EXCEPTION_SCREEN_DIAGNOSTIC ?= 0
HELENGINE_GAMECUBE_GENERATED_RUNTIME_MODULE_REGISTRATION_ENABLED ?= 1
HELENGINE_GAMECUBE_SYSTEM_REPORT_ENABLED ?= 1
HELENGINE_GAMECUBE_DIRECT_FRAME_DIAGNOSTIC ?= 0
HELENGINE_GAMECUBE_LOGO_ANIMATION_DIAGNOSTIC ?= 0
HELENGINE_GAMECUBE_INPUT_TRACE_DIAGNOSTIC ?= 0

ifeq ($(strip $(HELENGINE_GAMECUBE_FIRST_FRAME_TRACE_DIAGNOSTIC)),1)
HELENGINE_GAMECUBE_EXCEPTION_SCREEN_DIAGNOSTIC := 1
endif
...
CPPFLAGS := \
	...
	-DHELENGINE_GAMECUBE_MEMORY_CARD_DIAGNOSTIC_JOURNAL=$(HELENGINE_GAMECUBE_MEMORY_CARD_DIAGNOSTIC_JOURNAL) \
	-DHELENGINE_GAMECUBE_NINTENDONT_HANDOFF_DIAGNOSTIC=$(HELENGINE_GAMECUBE_NINTENDONT_HANDOFF_DIAGNOSTIC) \
	-DHELENGINE_GAMECUBE_FIRST_FRAME_TRACE_DIAGNOSTIC=$(HELENGINE_GAMECUBE_FIRST_FRAME_TRACE_DIAGNOSTIC) \
	-DHELENGINE_GAMECUBE_EXCEPTION_SCREEN_DIAGNOSTIC=$(HELENGINE_GAMECUBE_EXCEPTION_SCREEN_DIAGNOSTIC) \
	-DHELENGINE_GAMECUBE_GENERATED_RUNTIME_MODULE_REGISTRATION_ENABLED=$(HELENGINE_GAMECUBE_GENERATED_RUNTIME_MODULE_REGISTRATION_ENABLED) \
	-DHELENGINE_GAMECUBE_SYSTEM_REPORT_ENABLED=$(HELENGINE_GAMECUBE_SYSTEM_REPORT_ENABLED) \
	-DHELENGINE_GAMECUBE_DIRECT_FRAME_DIAGNOSTIC=$(HELENGINE_GAMECUBE_DIRECT_FRAME_DIAGNOSTIC) \
	-DHELENGINE_GAMECUBE_LOGO_ANIMATION_DIAGNOSTIC=$(HELENGINE_GAMECUBE_LOGO_ANIMATION_DIAGNOSTIC) \
	-DHELENGINE_GAMECUBE_INPUT_TRACE_DIAGNOSTIC=$(HELENGINE_GAMECUBE_INPUT_TRACE_DIAGNOSTIC)
...
else ifneq ($(wildcard $(HELENGINE_CORE_CPP_ROOT)/generated_unity.cpp),)
GENERATED_CORE_TRANSLATION_UNIT := generated_unity.cpp
else
$(error HELENGINE_CORE_CPP_ROOT does not contain helengine_core_amalgamated.cpp, helengine_core_unity.cpp, or generated_unity.cpp)
endif
...
GENERATED_BRIDGE_SOURCES := \
	...
	$(SOURCE_DIR)/platform/gamecube/GameCubeSceneTransitionTraceDiagnostics.cpp
ifeq ($(strip $(HELENGINE_GAMECUBE_BOOT_MODE)),packaged-disc)
GENERATED_BRIDGE_SOURCES += \
...
ifeq ($(strip $(HELENGINE_GAMECUBE_MEMORY_CARD_DIAGNOSTIC_JOURNAL)),1)
ALL_SOURCE_SOURCES += $(SOURCE_DIR)/platform/gamecube/GameCubeMemoryCardDiagnosticJournal.cpp
endif
ifeq ($(strip $(HELENGINE_GAMECUBE_EXCEPTION_SCREEN_DIAGNOSTIC)),1)
ALL_SOURCE_SOURCES += $(SOURCE_DIR)/platform/gamecube/GameCubeExceptionDiagnostics.cpp
endif
ifeq ($(strip $(HELENGINE_GAMECUBE_SYSTEM_REPORT_ENABLED)),0)
ALL_SOURCE_SOURCES += $(SOURCE_DIR)/platform/gamecube/GameCubeSystemReport.cpp
endif
